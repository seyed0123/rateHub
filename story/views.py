...
class info(View):
    def get(self, request, *args, **kwargs):
        ...
        try:
            data_obj = story.objects.get(id=post_id)
...
class new(View):
    def post(self, request, *args, **kwargs):
        ...
        if img is not None:
            post_obj = story(owner=user_id, img=img, text=text)
            post_obj.save()
...
class user_post(View):
    def get(self, request, *args, **kwargs):
        ...
        try:
            data_objects = story.objects.filter(owner=user_id)
...
class home_post(View):
    def get(self, request, *args, **kwargs):
            data_objects = story.objects.all()
